...
const Assignments = () => {
    const { assignmentList } = useSelector((state) => ({
        assignmentList: state.Tasks.taskList,
    }));
    ...
    const columns = useMemo(
      () => [
        ...
        },
        {
          ...
          filterable: false,
          Cell: (cellProps) => {
            return <div>{ cellProps.assignerCount }</div>;
          },
        },
        {
          Header: "Date",
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-shrink-0">
                                    <Link to="/assignment/new">
                                        <button className="btn btn-danger add-btn"><i className="ri-add-line align-bottom me-1"></i> Create Assignment</button>
                                    </Link>
                                </div>
                            </div>
                            </div>
