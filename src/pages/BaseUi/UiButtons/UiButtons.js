    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <MetaTags>
                    <title>Buttons | Velzon - React Admin & Dashboard Template</title>
                </MetaTags>
                <Container fluid>
